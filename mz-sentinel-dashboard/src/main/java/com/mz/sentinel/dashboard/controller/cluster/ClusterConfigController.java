 ...
 */
package com.mz.sentinel.dashboard.controller.cluster;

import com.alibaba.csp.sentinel.cluster.ClusterStateManager;
import com.alibaba.csp.sentinel.util.StringUtil;
import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.mz.sentinel.dashboard.client.CommandNotFoundException;
import com.mz.sentinel.dashboard.datasource.entity.SentinelVersion;
import com.mz.sentinel.dashboard.discovery.AppManagement;
import com.mz.sentinel.dashboard.domain.Result;
import com.mz.sentinel.dashboard.domain.cluster.request.ClusterClientModifyRequest;
import com.mz.sentinel.dashboard.domain.cluster.request.ClusterModifyRequest;
import com.mz.sentinel.dashboard.domain.cluster.request.ClusterServerModifyRequest;
import com.mz.sentinel.dashboard.domain.cluster.state.AppClusterClientStateWrapVO;
import com.mz.sentinel.dashboard.domain.cluster.state.AppClusterServerStateWrapVO;
import com.mz.sentinel.dashboard.domain.cluster.state.ClusterUniversalStatePairVO;
import com.mz.sentinel.dashboard.domain.cluster.state.ClusterUniversalStateVO;
import com.mz.sentinel.dashboard.service.ClusterConfigService;
import com.mz.sentinel.dashboard.util.ClusterEntityUtils;
import com.mz.sentinel.dashboard.util.VersionUtils;
