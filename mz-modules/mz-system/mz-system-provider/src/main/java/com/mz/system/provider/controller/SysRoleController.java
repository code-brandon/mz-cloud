...
public class SysRoleController {
    ...
    @GetMapping("/list")
    public R<SysRoleEntity> list(@RequestParam Map<String, Object> params){
     ...
     */
    @ApiImplicitParams({
            @ApiImplicitParam(name="sysRole",value="sysRole 实体对象",dataTypeClass = SysRoleEntity.class, paramType = "body",example="{'roleIds':[zahngsan,lisi]}")
    })
    @ApiOperation("删除数据")
