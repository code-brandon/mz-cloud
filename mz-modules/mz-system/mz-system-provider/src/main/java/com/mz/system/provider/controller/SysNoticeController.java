...
public class SysNoticeController {
     ...
     */
    @ApiOperation("保存通知公告")
    @MzLog(title = "通知公告",businessType = BusinessType.SAVE)
     ...
     */
    @ApiOperation("修改通知公告")
    @MzLog(title = "通知公告",businessType = BusinessType.UPDATE)
     ...
     */
    @ApiOperation("删除通知公告")
    @MzLog(title = "通知公告",businessType = BusinessType.REMOVE)
