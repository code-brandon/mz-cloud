...
public class SysNoticeController {
    ...
    @GetMapping("/list")
    public R<SysNoticeEntity> list(@RequestParam Map<String, Object> params){
     ...
     */
    @ApiImplicitParams({
            @ApiImplicitParam(name="sysNotice",value="sysNotice 实体对象",dataTypeClass = SysNoticeEntity.class, paramType = "body",example="{'name':'zahngsan'}")
    })
    @ApiOperation("保存数据")
    @PostMapping("/save")
     ...
     */
    @ApiImplicitParams({
            @ApiImplicitParam(name="sysNotice",value="sysNotice 实体对象",dataTypeClass = SysNoticeEntity.class, paramType = "body",example="{'noticeIds':[zahngsan,lisi]}")
    })
    @ApiOperation("删除数据")
    @DeleteMapping("/delete")
    public R delete(@RequestBody Integer[] noticeIds){
